...
- the v0.1 shells expose lifecycle controls, basic lineage graph projection, artifact logs, and a compact trust review queue; voice/STT, richer graph overlays, and full visual patch diffs remain later UI layers
